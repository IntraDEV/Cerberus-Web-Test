...
import com.example.jumpnote.allshared.JumpNoteProtocol.NotesCreate;
import com.example.jumpnote.allshared.JumpNoteProtocol.NotesEdit;
...
public class NoteEditor extends Screen {
    ...
    void onSaveClick(ClickEvent e) {
        ...
        EncodedNote note = new EncodedNote(noteTitle.getText(), noteBody.getText());
